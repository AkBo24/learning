...
urlpatterns = [
    ...
    path('dashboard/trip/<int:pk>/update', views.TripDetailView.as_view(), name='trip-update'),
    path('dashboard/trip/<int:pk>/delete', views.TripDetailView.as_view(), name='trip-delete'),
    ...
    path('dashboard/note/<int:pk>/update', views.NoteDetailView.as_view(), name='note-update'),
    path('dashboard/note/<int:pk>/delete', views.NoteDetailView.as_view(), name='note-delete'),
]
